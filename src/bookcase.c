...
/*void test (void)
{
   Testing check_for_same_colors function */
   /*assert(check_for_same_colors('1') == true);*/
   /*assert(check_for_same_colors('0') == true);*/
   /*assert(check_for_same_colors('3') == false);*/
   /*assert(check_for_same_colors('4') == false);*/
   /*assert(check_for_same_colors('5') == false);*/
   /*assert(check_for_same_colors('6') == false);*/
   /*assert(check_for_same_colors('7') == false);*/
   /*assert(check_for_same_colors('8') == false);*/
   /*assert(check_for_same_colors('9') == false);*/

   /*Testing that the array does not go out of bounds*/
   /*assert(safe(2, 2) == true);*/
   /*assert(safe(8, 8) == true);*/
   /*assert(safe(9, 9) == true);*/
   /*assert(safe(6, 6) == true);*/
   /*assert(safe(10, 10) == false);*/
   /*assert(safe(12, -1) == false);*/
   /*assert(safe(-3, -2) == false);*/
   /*assert(safe(2, -3) == false);*/
   /*assert(safe(2, 2) == true);*/
   /*assert(safe(8, 8) == true);*/
   /*assert(safe(9, 9) == true);*/
   /*assert(safe(6, 6) == true);*/
